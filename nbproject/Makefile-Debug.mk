...
${OBJECTDIR}/C02Fundamentals/Arrays/ArraysEx.o: C02Fundamentals/Arrays/ArraysEx.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Arrays/ArraysEx.o C02Fundamentals/Arrays/ArraysEx.cpp
...
${OBJECTDIR}/C02Fundamentals/Functions/ArraysAsParameters/ArraysAsParameters.o: C02Fundamentals/Functions/ArraysAsParameters/ArraysAsParameters.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Functions/ArraysAsParameters/ArraysAsParameters.o C02Fundamentals/Functions/ArraysAsParameters/ArraysAsParameters.cpp
...
${OBJECTDIR}/C02Fundamentals/Functions/FunctionsExample.o: C02Fundamentals/Functions/FunctionsExample.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Functions/FunctionsExample.o C02Fundamentals/Functions/FunctionsExample.cpp
...
${OBJECTDIR}/C02Fundamentals/Functions/ParamtersPassingMethods/ParametersSwappingMethods.o: C02Fundamentals/Functions/ParamtersPassingMethods/ParametersSwappingMethods.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Functions/ParamtersPassingMethods/ParametersSwappingMethods.o C02Fundamentals/Functions/ParamtersPassingMethods/ParametersSwappingMethods.cpp
...
${OBJECTDIR}/C02Fundamentals/PointerToStructure/PointersToStructures.o: C02Fundamentals/PointerToStructure/PointersToStructures.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/PointerToStructure/PointersToStructures.o C02Fundamentals/PointerToStructure/PointersToStructures.cpp
...
${OBJECTDIR}/C02Fundamentals/Pointers/C02PointersExamples.o: C02Fundamentals/Pointers/C02PointersExamples.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Pointers/C02PointersExamples.o C02Fundamentals/Pointers/C02PointersExamples.cpp
...
${OBJECTDIR}/C02Fundamentals/References/C02ReferencesExamples.o: C02Fundamentals/References/C02ReferencesExamples.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/References/C02ReferencesExamples.o C02Fundamentals/References/C02ReferencesExamples.cpp
...
${OBJECTDIR}/C02Fundamentals/Structures/C02StructuresExamples.o: C02Fundamentals/Structures/C02StructuresExamples.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Structures/C02StructuresExamples.o C02Fundamentals/Structures/C02StructuresExamples.cpp

${OBJECTDIR}/C02Fundamentals/Structures/Card.o: C02Fundamentals/Structures/Card.cpp
	${MKDIR} -p ${OBJECTDIR}/C02Fundamentals/Structures
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Structures/Card.o C02Fundamentals/Structures/Card.cpp

${OBJECTDIR}/C02Fundamentals/Structures/Complex.o: C02Fundamentals/Structures/Complex.cpp
	${MKDIR} -p ${OBJECTDIR}/C02Fundamentals/Structures
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Structures/Complex.o C02Fundamentals/Structures/Complex.cpp

${OBJECTDIR}/C02Fundamentals/Structures/Rectangle.o: C02Fundamentals/Structures/Rectangle.cpp
	${MKDIR} -p ${OBJECTDIR}/C02Fundamentals/Structures
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Structures/Rectangle.o C02Fundamentals/Structures/Rectangle.cpp

${OBJECTDIR}/C02Fundamentals/Structures/Student.o: C02Fundamentals/Structures/Student.cpp
	${MKDIR} -p ${OBJECTDIR}/C02Fundamentals/Structures
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C02Fundamentals/Structures/Student.o C02Fundamentals/Structures/Student.cpp
